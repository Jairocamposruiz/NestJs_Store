...
export class createUserCustomer1623687098986 implements MigrationInterface {
    name = 'createUserCustomer1623687098986'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer" ADD "phone" character varying(100) NOT NULL`);
